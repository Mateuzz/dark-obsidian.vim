...
let s:yellow = "#eCeCAA"
let s:lightYellow = '#efdb8f'
let s:ecYellow = '#ffb00a'
let s:cdLightGreen = '#B5CEA8'
let s:lineNrColor = '#98a59f'
let s:variableColor = '#c5bdbd'

" Syntax
execute "hi Normal  guifg="     . s:variableColor  . " guibg=" . s:Colors[12] . " gui=none"
...
execute "hi Constant guifg="    . s:Colors[0]  . " guibg=" . s:Colors[12] . " gui=none"
...
execute "hi String guifg="      . s:ecYellow  . " guibg=" . s:Colors[12] . " gui=none"
...
" execute "hi lCursor guifg="      . s:Colors[12] . " guibg=" . s:Colors[2]  . " gui=none"
execute "hi CursorIM guifg="    . s:Colors[7]  . " guibg=" . s:Colors[5]  . " gui=none"
execute "hi CursorLine guifg=NONE guibg=" . s:colorLine
...
execute "hi LineNr guifg="      . s:lineNrColor  . " guibg=" . s:Colors[12] . " gui=none"
...
execute "hi Visual  guifg="     . s:Colors[12]  . " guibg=" . s:Colors[0]  . " gui=none"
...
execute "hi @variable guifg="      . s:variableColor  . " guibg=" . s:Colors[12] . " gui=none"
...
execute "hi @parameter guifg="      . s:variableColor  . " guibg=" . s:Colors[12] . " gui=none"
execute "hi @constructor guifg="      . s:yellow  . " guibg=" . s:Colors[12] . " gui=none"
execute "hi @function guifg="  . s:yellow . " guibg=" . s:Colors[12] . " gui=none"
execute "hi @constant guifg="  . s:cdLightGreen . " guibg=" . s:Colors[12] . " gui=none"
execute "hi @constant.builtin guifg="  . s:Colors[2] . " guibg=" . s:Colors[12] . " gui=none"
execute "hi @method guifg="  . s:yellow . " guibg=" . s:Colors[12] . " gui=none"
...
execute "hi htmlArg guifg="  . s:lightYellow . " guibg=" . s:Colors[12] . " gui=none"

execute "hi cssProp guifg="  . s:lightYellow . " guibg=" . s:Colors[12] . " gui=none"
